...
import 'core/Firebase/FirebaseFunctions.dart' as _i4;
import 'core/Location/location.dart' as _i5;
import 'features/Details/data/data_sources/detailsDs.dart' as _i22;
import 'features/Details/data/data_sources/DetailsDsImp.dart' as _i23;
import 'features/Details/data/repositories/detailsRepoImp.dart' as _i25;
import 'features/Details/domain/repositories/detailsRepo.dart' as _i24;
import 'features/Details/domain/use_cases/DetailsUseCase.dart' as _i26;
import 'features/Details/presentation/bloc/details_bloc.dart' as _i30;
...
import 'features/News/presentation/bloc/news_bloc.dart' as _i28;
...
import 'features/signUp/presentation/bloc/sign_up_bloc.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i22.DetailsDs>(
        () => _i23.DetailsDSImp(gh<_i4.FirebaseFunctions>()));
    gh.factory<_i24.DetailsRepo>(
        () => _i25.DetailsRepoImp(gh<_i22.DetailsDs>()));
    gh.factory<_i26.DetailsUseCase>(
        () => _i26.DetailsUseCase(gh<_i24.DetailsRepo>()));
    gh.factory<_i27.LoginBloc>(() => _i27.LoginBloc(gh<_i10.LoginUseCase>()));
    gh.factory<_i28.NewsBloc>(() => _i28.NewsBloc(gh<_i15.NewsUseCase>()));
    gh.factory<_i29.SignUpBloc>(() => _i29.SignUpBloc(
          gh<_i20.SignUpUseCase>(),
          gh<_i21.StoreUserUseCase>(),
        ));
    gh.factory<_i30.DetailsBloc>(() => _i30.DetailsBloc(
          gh<_i5.GetCurrentLocation>(),
          gh<_i26.DetailsUseCase>(),
        ));
    return this;
  }
}
